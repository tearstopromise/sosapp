...
function onCaptureSuccess(imageData) {
    ...
    var photo = getElement("pic");
	  var photo5 = getElement("picc");
	 
	  var photo6 = getElement("picc1");
    var photo2 = getElement("pic2");

    var photo1 = getElement("pic1");
	
    var photo3= getElement("pic3");
   ...
   photo6.style.display = "block";
    photo.src = imageData;
	photo1.value  = "data:image/jpeg;base64," + imageData ;
	 photo5.src = "data:image/jpeg;base64," + imageData;
	 photo6.src = "data:image/jpeg;base64," + imageData;
	photo3.value= photo5.src ;
	photo2.innerHTML  = photo5.src;
